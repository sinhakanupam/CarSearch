...
<html lang="zxx">
<head runat="server">
<title>Commercial a Corporate Category Bootstrap Responsive website Template | Home :: w3layouts</title>
<!-- Meta tag Keywords -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="commercial Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
...
<!-- //css files -->
<!-- web-fonts -->
<link href="//fonts.googleapis.com/css?family=Fira+Sans:100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i&amp;subset=cyrillic,cyrillic-ext,greek,greek-ext,latin-ext,vietnamese" rel="stylesheet">
...
<div class="header">
	<div class="container">
		<div class="agile-top-header">
			<h1><a href="index.html">commercial</a></h1>
			...
			<div class="top-left">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							 <nav class="linkEffects linkHoverEffect_2">
								<ul>
									...
									<li><a href="#team" data-link-alt="TEAM" class="scroll"><span>Team</span></a></li> 
									<li><a href="#gallery" data-link-alt="Projects" class="scroll"><span>Projects</span></a></li> 
									<li><a href="#mail" data-link-alt="MAIL US" class="scroll"><span>Mail Us</span></a></li> 
								</ul>
							</nav>
						</div>
						<div class="clearfix"> </div>	
				...
				<!-- //navigation -->
				<div class="w3l_header_right w3l-r">
					<ul>
						...
						<ul class="slides">
							<li>
								<div class="banner-w3lstext">
									...
									<a href="#" class="view rew3" data-toggle="modal" data-target="#myModal1"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Learn More</a>
								</div>
							</li>
							<li>
								<div class="banner-w3lstext">
									<p>Perspiciatis</p>
									<h3>Integer gravida gravid</h3>
									<a href="#" class="view rew3" data-toggle="modal" data-target="#myModal1"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Learn More</a>
								</div>
							</li>
							<li>
         ...
         <asp:TextBox ID="TextBox1" runat="server" CssClass="search-agileTextBox"></asp:TextBox>
         <asp:Button ID="Button1" data-toggle="modal" data-target="#myModal1" runat="server" Text="Button" 
             CssClass="search-agileSubmitButton" />
					<div class="clearfix"> </div>
				</form> 
			</div>
		</div>
...
<!-- //header -->
<!-- about -->
<div class="why-w3l" id="about">
	<div class="container">
	<h3 class="tittle-w3">About Us</h3>
		<div class="why-grid">
			<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt consectetur adipiscing elit, sed do eiusmod tempor incididuntut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
			<ul>
				<li><i class="fa fa-share" aria-hidden="true"></i>Sed massa tellus aliquam rhoncus venenatis </li>
				<li><i class="fa fa-share" aria-hidden="true"></i>Consectetur adipiscing elit. Aenean consequat</li>
				<li><i class="fa fa-share" aria-hidden="true"></i>Fusce euismod consequat ante. Lorem ipsum </li>
			</ul>
		</div>
		<div class="why-grid">
			<iframe src="https://player.vimeo.com/video/124902958"></iframe> 
		</div>
		<div class="clearfix"></div>
	</div>
</div>
<!-- //about -->
<!-- services -->
<div class="services-w3l" id="services">
	<div class="container">
		<h3 class="tittle-w3">Services</h3>
		<p class="w3l-p">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt consectetur adipiscing elit, sed do eiusmod tempor incididuntut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
		<div class="w3-agile-ser">
			<div class="col-md-4 col-sm-4 col-xs-4 ser-agileits">
				<i class="fa fa-envelope-o" aria-hidden="true"></i> 
				<p>Email marketing</p>
			</div>
			<div class="col-md-4 col-sm-4 col-xs-4 ser-agileits">
				<i class="fa fa fa-clone" aria-hidden="true"></i> 
				<p>Data analyzing</p>
			</div>
			<div class="col-md-4 col-sm-4 col-xs-4 ser-agileits w3l-sermo sec-mk">
				<i class="fa fa-heart-o" aria-hidden="true"></i>
				<p>Best Services</p>
			</div>
		</div>
		<div class="w3-agile-ser-w3">
			<div class="col-md-4 col-sm-4 col-xs-4 ser-agileits w3l-sermo">
...
<div class="team" id="team">
	<div class="container">
		<h3 class="tittle-w3">Our Team</h3>
		<div class="agile-team-grids">
			<div class="col-md-3 col-sm-3 col-xs-3 team-grid">
				<div class="team-img">
...
<div id="gallery" class="gallery">  
	<h3 class="tittle-w3">Our Projects</h3>
	<div class="gallery-w3l"> 
		<div class="col-sm-6 col-xs-12 gallery-wthreegrids"> 
			<div class="gallery-grid-row"> 
				<div class="col-sm-6 col-xs-6 gallery-grid">   
				...
				<div class="col-sm-6 col-xs-6 gallery-grid gallery-text">
					<h4>Project One</h4> 
			...
			<div class="gallery-grid-row"> 
				<div class="col-sm-6 col-xs-6 gallery-grid gallery-grid3">  
				...
				<div class="col-sm-6 col-xs-6 gallery-grid gallery-text3">
					<h4>Project Two</h4>  
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit tincidunt ellus feugiat porttitor nulla magna vitae nisl </p>
				</div>
				<div class="clearfix"> </div> 
...
<div class="test">
	<div class="container">
		<h3 class="tittle-w3">CUSTOMER FEEDBACK</h3>
		<div class="test-gri1">
...
<div class="mail" id="mail">
	<div class="container">
		<h3 class="tittle-w3">Mail Us</h3>
		<div class="mail-w3l-agile">
			<div class="col-md-5 col-sm-5 contact-left-w3ls">
				<h3>Contact Info</h3>
				<div class="visit">
...
<div class="footer-bot">
	<div class="container">
		<div class="col-md-3 logo2">
			<h2><a href="index.html">commercial</a></h2>
		</div>
		<div class="col-md-7 col-sm-9 col-xs-9 ftr-menu">
			 <ul>
				<li><a href="index.html">Home</a></li>
				<li><a class="scroll" href="#about">About</a></li>
				<li><a class="scroll" href="#services">Services</a></li>
				<li><a class="scroll" href="#team">Team</a></li>
				<li><a class="scroll" href="#gallery">Projects</a></li>
				<li><a class="scroll" href="#mail">Mail Us</a></li>
			 </ul>
		</div>
		<div class="col-md-2 col-sm-3 col-xs-3 ftr-menu">
...
<div class="copy-right">
	<div class="container">
		<p> &copy; 2017 commercial. All Rights Reserved | Design by  <a href="http://w3layouts.com/"> W3layouts</a></p>
	</div>
</div>
<!-- //footer -->
